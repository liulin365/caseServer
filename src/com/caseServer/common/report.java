...
public class report {
	...
	public void sendreport (String resultFile,String startTime)  {
		...
		map.put("email", "251439824@qq.com");
		map.put("mailpass", "xawlgkiflhicbhdh");
		map.put("sendnick", "wangping");
		map.put("host", "smtp.qq.com");
		map.put("recievers", "2634878653@qq.com");
		map.put("copylist", "2634878653@qq.com");
