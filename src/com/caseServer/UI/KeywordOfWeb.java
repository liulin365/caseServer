...
//			显式等待，在规定时间内找到xpath才会执行下一行代码
	...
	public void outIframe() {
		...
		try {
			...
			AutoLogger.log.info("切出Iframe成功");
		} catch (Exception e) {
			AutoLogger.log.error(e,e.fillInStackTrace());
...
//	}
	...
	// 实现通过value选择select的选项，当页面上有下拉选项时会用到
	...
	public void login(String username,String password) {
		try {
			visitWeb("http://192.168.12.241:8080/caseServer/login.action");
			halt("5");
...
//		保存住院号参数
			...
			String zyh="";	
			zyh=getJs("document.getElementsByClassName(\"datagrid-cell datagrid-cell-c2-zyh\")[0].innerText");
				return zyh;
			}
//			实现鼠标双击
